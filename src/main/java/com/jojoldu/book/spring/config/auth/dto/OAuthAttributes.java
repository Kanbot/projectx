...
public class OAuthAttributes {
    ...
    public static OAuthAttributes of(String registrationId , String userNamAttributeName , Map<String ,Object>attributes){
        return OAuthAttributes.builder().name((String) attributes.get("name"))
                .email((String) attributes.get("email"))
                .picture((String) attributes.get("picture"))
                .attributes(attributes)
                .nameAttributeKey(userNamAttributeName)
                .build();
    ...
    public User toEntity(){
        return User.builder().
                name(name).email(email).role(Role.GUEST).picture(picture).
                build();
